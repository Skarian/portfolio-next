      ...
      <ul className="absolute hidden text-gray-700 pt-1 group-hover:block">
        <li className="">
          <a
            ...
            href={`mailto:info@example.com?&subject=&body=https://neilskaria.com/blog/${slug}`}
          >
            E-Mail
          </a>
        </li>
        <li className="">
          <a
            ...
            href={`https://twitter.com/intent/tweet?url=https://neilskaria.com/blog/${slug}&text=Checkout this article!`}
          >
            Twitter
          </a>
        </li>
        <li className="">
          <a
            className="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap text-xs md:text-sm"
            href={`https://www.linkedin.com/shareArticle?mini=true&url=https://neilskaria.com/blog/${slug}&title=&summary=Checkout this article!&source=`}
          >
            Linkedin
          </a>
        </li>
